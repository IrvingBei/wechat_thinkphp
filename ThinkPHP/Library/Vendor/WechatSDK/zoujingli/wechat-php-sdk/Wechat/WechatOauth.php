...
class WechatOauth extends Common
{
    ...
    public function getOauthRedirectUrlByGWC($callback, $oauth_url, $state = '', $scope = 'snsapi_base'){
        $redirect_uri = urlencode($callback);
        ...
        return $oauth_url . "?appid={$this->appid}&scope={$scope}&state={$state}&redirect_uri={$redirect_uri}";
